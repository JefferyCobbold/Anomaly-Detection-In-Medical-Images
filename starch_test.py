...
# Calculate mean values across specified columns and create a new DataFrame
...
# Extract Wavelength column for plotting
Wavelength = df["Wavelength"]

# Plotting
plt.figure(figsize=(15, 10))
for column in data_frame.columns:
    #prominent_values = data_frame[column].where(data_frame[column] > threshold)
    plt.plot(Wavelength ,data_frame[column], label=column)

    #plt.plot(prominent_values ,Wavelength, label=column)
